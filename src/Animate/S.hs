              ...
              NodeFaults nis dt -> do
                ...
                lift $
                  traceWith
                    ...
                    (TimeWrapper ct $ NodeRestart nis dt)
                mapM_ killNode nis
                lift $ threadDelay dt
...
tenv =
  Env
    { nodeIds = [NodeId 0, NodeId 1, NodeId 2, NodeId 3, NodeId 4]
    , netDelayRange = (0.02, 0.04)
    , electionTimeRange = (0.2, 0.4)
    , heartbeatWaitTime = 0.1
    , appendEntriesRpcRetryWaitTime = 1
    ...
    , faultsSeq =
        [ NetworkFaults
            ...
            ,
              ( [NodeId 2]
              , [NodeId 4, NodeId 1, NodeId 3, NodeId 0]
              )
            , [(NodeId 2, NodeId 4), (NodeId 2, NodeId 1), (NodeId 2, NodeId 3), (NodeId 2, NodeId 0)]
            )
        , NodeFaults [NodeId 3, NodeId 0] 2.07722894215
        , NodeFaults [NodeId 4] 2.920903395415
        , NetworkFaults
            ( 2.532817890021
            ,
              ( [NodeId 2, NodeId 1]
              , [NodeId 0, NodeId 4, NodeId 3]
              )
            , [(NodeId 2, NodeId 0), (NodeId 2, NodeId 4), (NodeId 2, NodeId 3), (NodeId 1, NodeId 0), (NodeId 1, NodeId 4), (NodeId 1, NodeId 3)]
            )
        , NetworkFaults
            ( 2.949952952575
            , ([NodeId 1], [NodeId 4, NodeId 3, NodeId 2, NodeId 0])
            , [(NodeId 1, NodeId 4), (NodeId 1, NodeId 3), (NodeId 1, NodeId 2), (NodeId 1, NodeId 0)]
            )
        ]
    , randomI = 785496586898680085
    }
...
ntoh :: NTracer a -> IdWrapper (HandleTracer a)
ntoh (N2 h) = h
ntoh _ = undefined
